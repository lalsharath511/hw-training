...
class ColdwellBanker():
	...
	def parse(self,url):
		...
		'languages': selector.xpath('//ul[contains(@class,"languages")]/li/text()').extract(),
		'address': address1[0],
		'city': ads[0].replace(',',''),
		'zip_code': ads[2],
		'state': ads[1],
		'agent_phone': selector.xpath('//div[@class="media__content"]/a[contains(@href,"tel")]/text()').extract(),
